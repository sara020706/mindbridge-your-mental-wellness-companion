...
const quickPrompts = [
  ...
  { emoji: "🌬️", text: "Tell me a breathing exercise" },
...
export default function AIAssistant() {
  ...
  const handleSend = async (text?: string) => {
    ...
    setTimeout(() => {
      const responses = [
        "I understand that can be challenging. Let's work through this together. Can you tell me more about what's causing these feelings?",
        "That's a great step in recognizing how you feel. Remember, it's okay to take things one moment at a time.",
        "I hear you. Let's try a simple grounding exercise: Name 5 things you can see right now.",
        "Your feelings are valid. Would you like to explore some coping strategies that might help?",
      ];
        ...
        <div className="lg:col-span-3 flex flex-col">
          ...
          >
            <div>
              ...
              <p className="opacity-90 text-sm">24/7 support through text and voice</p>
            </div>
        ...
        <div className="hidden lg:block space-y-4">
          ...
          <div className="space-y-3">
            {conversationStarters.map((starter, i) => (
              <button
                key={i}
                onClick={() => handleSend(`I'd like to explore ${starter.title.toLowerCase()}`)}
                className="w-full p-4 bg-card rounded-xl border border-border hover:border-primary transition-colors text-left group"
              >
                <div className="flex items-center gap-3">
